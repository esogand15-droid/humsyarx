...
const SECTIONS = [
...

  {
    icon: '🚨',
    title: 'نیازمند اقدام',
    description: 'صف کار معوق، هم‌تراز با پنل وب',
  ...
  },
  {
    icon: '🧰',
    title: 'میز عملیات',
    description: 'کار من، هشدار و کیفیت داده',
  ...
  },
  {
    icon: '🧪',
    title: 'بانک سؤال',
    description: 'بازبینی، سلامت و پرونده کامل',
  ...
  {
    icon: '🎚️',
    title: 'دسترسی قابلیت‌ها',
    description: 'روشن، اشتراک و سهمیه',
  ...
  },
  {
    icon: '🌱',
    title: 'رشد و دعوت',
    description: 'ریفرال، جایزه و یادآوری پرداخت',
    route: '/admin/growth',
    color: 'var(--t-ok)',
    soft: 'var(--soft-ok)',
  },
  {
    icon: '💬',
    title: 'رینگ گفت‌وگو',
    description: 'وضعیت، صف، گزارش و محدودیت',
    route: '/admin/ring',
    color: 'var(--t-info)',
    soft: 'var(--soft-info)',
  },
  {
    icon: '📤',
    title: 'صف سیستم',
    description: 'کارهای زمان‌بندی و پیام نرسیده',
    route: '/admin/system',
    color: 'var(--t-warn)',
    soft: 'var(--soft-warn)',
  },
  {
    icon: '💰',
    title: 'مرکز مالی',
    description: 'درآمد، مغایرت و کیف پول',
    route: '/admin/finance',
    color: 'var(--t-ok)',
    soft: 'var(--soft-ok)',
  },
  {
    icon: '📝',
    title: 'آزمون‌ها',
    description: 'ثبت، وضعیت و خبر لغو',
    route: '/admin/exams',
    color: 'var(--t-acc)',
    soft: 'var(--soft-acc)',
  },
