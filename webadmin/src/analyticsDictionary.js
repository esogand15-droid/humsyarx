...
export const ANALYTICS_DICTIONARY = {
  ...
  content: {
    ...
    qbank_files: { label: 'فایل‌های بانک سؤال', unit: 'فایل', range: 'وضعیت فعلی', source: 'qbank_files', calculation: 'تعداد کل فایل‌های بانک سؤال', action: '/content?tab=qbank' },
    ...
    qbank_downloads: { label: 'دانلود فایل‌های بانک سؤال', unit: 'دانلود', range: 'تجمعی از ابتدای ثبت داده', source: 'qbank_files.downloads', calculation: 'جمع شمارنده downloads فایل‌های بانک سؤال', action: '/content?tab=qbank' },
    new_this_week: { label: 'منابع افزوده‌شده در ۷ روز اخیر', unit: 'فایل', range: '۷ روز rolling', source: 'bs_content + ref_files', calculation: 'فایل‌های علوم پایه و رفرنس با uploaded_at در ۷ روز اخیر' },
  },
  questions: {
